...
class BasicCANMecanum(yeti.Module):
    ...
    forward_percentage_in = 0
    right_percentage_in = 0
    clockwise_percentage_in = 0

    def set_drive(self, forward_percentage, right_percentage, clockwise_percentage):
        self.forward_percentage_in = forward_percentage
        self.right_percentage_in = right_percentage
        self.clockwise_percentage_in = clockwise_percentage
    ...
    def enabled_init(self):
        ...
        while self.gameclock.is_enabled():
            ...
            if self.gameclock.is_teleop():
                ...
                forward_percentage = self.forward_percentage_in
                right_percentage = self.right_percentage_in
                clockwise_percentage = self.clockwise_percentage_in
